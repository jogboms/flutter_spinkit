...
void main() {
  group('Ripple', () {
    testWidgets('needs either color or itemBuilder', (WidgetTester tester) async {
      ...
      expect(() => SpinKitRipple(color: Colors.white, itemBuilder: fakeBoxBuilder), throwsAssertionError);
    });
    ...
    testWidgets('works with color', (WidgetTester tester) async {
      await tester.pumpWidget(createMaterialApp(const SpinKitRipple(color: Colors.white)));
    ...
    testWidgets('works with itemBuilder', (WidgetTester tester) async {
      await tester.pumpWidget(createMaterialApp(const SpinKitRipple(itemBuilder: fakeBoxBuilder)));
      expect(find.byType(SpinKitRipple), findsOneWidget);
    ...
    testWidgets('works without Material', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetsApp(const SpinKitRipple(color: Colors.white)));
      expect(find.byType(SpinKitRipple), findsOneWidget);
      expect(find.byType(DecoratedBox), findsWidgets);
      tester.verifyTickersWereDisposed();
    });
