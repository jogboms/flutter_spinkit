...
void main() {
  group('ThreeBounce', () {
    ...
    testWidgets('works with color', (WidgetTester tester) async {
      await tester.pumpWidget(createMaterialApp(const SpinKitThreeBounce(color: Colors.white)));
    ...
    testWidgets('works with itemBuilder', (WidgetTester tester) async {
      await tester.pumpWidget(createMaterialApp(const SpinKitThreeBounce(itemBuilder: fakeBoxBuilder)));
      expect(find.byType(SpinKitThreeBounce), findsOneWidget);
    ...
    testWidgets('works without Material', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetsApp(const SpinKitThreeBounce(color: Colors.white)));
      expect(find.byType(SpinKitThreeBounce), findsOneWidget);
      expect(find.byType(DecoratedBox), findsWidgets);
      tester.verifyTickersWereDisposed();
    });
