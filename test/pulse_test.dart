...
void main() {
  group('Pulse', () {
    ...
    testWidgets('works with color', (WidgetTester tester) async {
      await tester.pumpWidget(createMaterialApp(const SpinKitPulse(color: Colors.white)));
    ...
    testWidgets('works with itemBuilder', (WidgetTester tester) async {
      await tester.pumpWidget(createMaterialApp(const SpinKitPulse(itemBuilder: fakeBoxBuilder)));
      expect(find.byType(SpinKitPulse), findsOneWidget);
    ...
    testWidgets('works without Material', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetsApp(const SpinKitPulse(color: Colors.white)));
      expect(find.byType(SpinKitPulse), findsOneWidget);
      expect(find.byType(DecoratedBox), findsWidgets);
      tester.verifyTickersWereDisposed();
    });
