...
void main() {
  group('RotatingPlain', () {
    ...
    testWidgets('works with color', (WidgetTester tester) async {
      await tester.pumpWidget(createMaterialApp(const SpinKitRotatingPlain(color: Colors.white)));
    ...
    testWidgets('works with itemBuilder', (WidgetTester tester) async {
      await tester.pumpWidget(createMaterialApp(const SpinKitRotatingPlain(itemBuilder: fakeBoxBuilder)));
      expect(find.byType(SpinKitRotatingPlain), findsOneWidget);
    ...
    testWidgets('works without Material', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetsApp(const SpinKitRotatingPlain(color: Colors.white)));
      expect(find.byType(SpinKitRotatingPlain), findsOneWidget);
      expect(find.byType(DecoratedBox), findsWidgets);
      tester.verifyTickersWereDisposed();
    });
