...
void main() {
  group('SquareCircle', () {
    testWidgets('needs either color or itemBuilder', (WidgetTester tester) async {
      ...
      expect(() => SpinKitSquareCircle(color: Colors.white, itemBuilder: fakeBoxBuilder), throwsAssertionError);
    });
    ...
    testWidgets('works with color', (WidgetTester tester) async {
      await tester.pumpWidget(createMaterialApp(const SpinKitSquareCircle(color: Colors.white)));
    ...
    testWidgets('works with itemBuilder', (WidgetTester tester) async {
      await tester.pumpWidget(createMaterialApp(const SpinKitSquareCircle(itemBuilder: fakeBoxBuilder)));
      expect(find.byType(SpinKitSquareCircle), findsOneWidget);
    ...
    testWidgets('works without Material', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetsApp(const SpinKitSquareCircle(color: Colors.white)));
      expect(find.byType(SpinKitSquareCircle), findsOneWidget);
      expect(find.byType(DecoratedBox), findsWidgets);
      tester.verifyTickersWereDisposed();
    });
