...
void main() {
  group('SpinningCircle', () {
    ...
    testWidgets('works with color', (WidgetTester tester) async {
      await tester.pumpWidget(createMaterialApp(const SpinKitSpinningCircle(color: Colors.white)));
    ...
    testWidgets('works with itemBuilder', (WidgetTester tester) async {
      await tester.pumpWidget(createMaterialApp(const SpinKitSpinningCircle(itemBuilder: fakeBoxBuilder)));
      expect(find.byType(SpinKitSpinningCircle), findsOneWidget);
    ...
    testWidgets('works without Material', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetsApp(const SpinKitSpinningCircle(color: Colors.white)));
      expect(find.byType(SpinKitSpinningCircle), findsOneWidget);
      expect(find.byType(DecoratedBox), findsWidgets);
      tester.verifyTickersWereDisposed();
    });
